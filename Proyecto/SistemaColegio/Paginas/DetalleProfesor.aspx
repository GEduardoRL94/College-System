<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DetalleProfesor.aspx.cs" Inherits="SistemaColegio.Paginas.DetalleProfesor" %>
<!DOCTYPE html>
...
<body>
    ...
    <div>
        ...
        <div class="Fila Subtitulo">Datos del Profesor</div>
        <div class="Fila">
        ...
        <div class="Fila">
            <div class="Campo" style="width:20%">Tipo:</div>
            <div class="Campo" style="width:80%">
                <asp:DropDownList ID="cboTipo" runat="server">
                    <asp:ListItem Value="1">Reemplazo</asp:ListItem>
                    <asp:ListItem Value="2">Estable</asp:ListItem>
                </asp:DropDownList>
            </div>
        </div>  
        <div class="Fila">
            <div class="Campo" style="width:20%">FechaCon:</div>
            <div class="Campo" style="width:80%"><asp:TextBox ID="txtFechaCon" Width="100" MaxLength="10" runat="server" /></div>
        </div>
        <div class="Fila Centro">
            <asp:ImageButton ID="imgGuardar" ImageUrl="~/Imagenes/Guardar.png" CssClass="Icono" ToolTip="Guardar Profesor" OnClick="imgGuardar_Click" runat="server" />
    ...
    <script src="../../Scripts/DetalleProfesor.js"></script>
</body>
</html>
